...
#while read line; do c=`echo $line`; k=`echo $c | ./clue`; echo "$k, $c"; done < examples/set4/set4.c 
#while read line; do c=`echo $line`; k=`echo $c | ./clue`; echo "$k, $c"; done < examples/set5/set5.c 
while read line; do c=`echo $line`; k=`echo $c | ./clue`; echo "$k, $c"; done < examples/set6/set6.c 
